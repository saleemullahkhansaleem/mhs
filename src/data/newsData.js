export const newsData = [
  {
    ...
    author: "Sarah Khan",
    description:
      "This partnership aims to enhance the capabilities of businesses by providing them with tailored e-commerce solutions that leverage advanced technology.",
    content: [
      {
  ...
  {
    title: "MHS Launches New AI-Powered Portal Management System",
    excerpt:
      "Our cutting-edge AI-powered portal management system is set to revolutionize how organizations manage and optimize their digital platforms.",
    image: "/images/news/2.webp",
    url: "/news/ai-powered-portal-system",
    date: "September 30, 2024",
    category: "Product Launch",
    author: "Ahmed Ali",
    description:
      "The new portal management system integrates artificial intelligence to provide organizations with powerful tools for managing their digital platforms efficiently.",
    content: [
      {
        heading: "Key Features",
        detail: [
          "The AI-powered system offers advanced analytics, real-time monitoring, and customizable workflows, enabling organizations to optimize their portal management effectively.",
          "This innovative solution aims to streamline operations and enhance user experience across digital platforms.",
        ],
      },
      {
